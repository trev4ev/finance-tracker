...
function triggerClass(tone: Tone, open: boolean) {
  ...
  return `flex min-h-11 w-full items-center justify-between gap-2 rounded-xl border px-3 py-2 text-left text-sm outline-none disabled:cursor-not-allowed disabled:opacity-60 ${bg} ${
